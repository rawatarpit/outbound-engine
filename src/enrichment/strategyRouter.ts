...
function buildCompanyPlan(
  ...
  // Website scrape for real contacts (open source, finds emails from team pages)
  strategies.push(EnrichmentStrategyType.WEBSITE_SCRAPE)

  // LLM-based contact discovery (open source, Google scraping for names/titles)
  strategies.push(EnrichmentStrategyType.CONTACT_DISCOVERY)

  // LLM fallback for deep company understanding (open source, Ollama)
  strategies.push(EnrichmentStrategyType.LLM_RESEARCH)
